...
namespace Cats
{
    public class AiTaskPlayWithEntity : AiTaskSeekEntity
    {
        ...
        readonly private string[] playAnimations;
        ...
        {
            playAnimations = taskConfig["playAnimations"].AsArray<string>([]);
        }
        public override bool ShouldExecute()
        {
            ...
            if (lastCheck + cooldownUntilMs < ellapsedMs)
            {
                ...
                targetEntity = partitionUtil.GetNearestInteractableEntity(entity.Pos.XYZ, seekingRange, e => IsTargetableEntity(e, seekingRange));
        ...
        public override bool ContinueExecute(float dt)
        {
            ...
            else if (entity.Pos.SquareHorDistanceTo(targetEntity.Pos.XYZ) < MinDistanceToTarget() * 2)
            {
                finished = true;
